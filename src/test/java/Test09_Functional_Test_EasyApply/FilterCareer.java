...
public class FilterCareer extends ConfigDriver {
    ...
    public void filterJobSearch() throws InterruptedException {
        ...
        topSearchIcon.click();
        careerSearch.click();
        careerSearch.sendKeys("Business Analyst"); //Validate Jobs Search (+ , -), Test Case
        Thread.sleep(1000);
    ...
    public Test08_Sanity_User_Applied.AutomateJobSelection filterDiceSelection() throws InterruptedException {
        filterJobSearch();
